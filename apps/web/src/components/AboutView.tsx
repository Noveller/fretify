  ...
  return (
    <div className="w-full max-w-xl mx-auto flex flex-col gap-8">
      ...
      <div className="rounded-2xl p-6 flex flex-col gap-4"
        ...
        <a
          href="https://www.patreon.com/c/alexceb"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium text-center transition-all hover:opacity-90"
          style={{ backgroundColor: '#FF424D', color: '#fff' }}
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            <path d="M14.82 2.41C18.78 2.41 22 5.65 22 9.62c0 3.96-3.22 7.18-7.18 7.18-3.96 0-7.17-3.22-7.17-7.18 0-3.97 3.21-7.21 7.17-7.21zM2 21.6h3.5V2.41H2V21.6z"/>
          </svg>
          Patreon
        </a>
      </div>
